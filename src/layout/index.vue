<template>
  <div style="position: relative; width: 100vw; height: 100vh; overflow: hidden;" class="">
    ...
    <header v-show="!$route.meta.modulePage && $route.meta.hiddenTop != true"
      class="dark:bg-slate-900 text-xl flex items-center justify-between dark:text-white px-2 py-1">
      <span @click="goBack"><svg xmlns="http://www.w3.org/2000/svg" width="1.7em" height="1.7em" viewBox="0 0 24 24">
      ...
      <span><svg xmlns="http://www.w3.org/2000/svg" width="1.7em" height="1.7em" viewBox="0 0 32 32">
          <path fill="black" d="M10 6h18v2H10zm0 18h18v2H10zm0-9h18v2H10zm-6 0h2v2H4zm0-9h2v2H4zm0 18h2v2H4z" />
        </svg></span>
    </header>
    <!-- </transition> -->
    ...
    <footer v-show="$route.meta.modulePage"
      class="fixed bottom-0 left-0 w-screen px-2 py-1 border-t-2 border-black-500 text-black bg-white z-40">
      <div class=" pt-1 bg-white">
        <div class="flex flex-row space-x-3 justify-center gap-2">
          <!-- Item #1 -->
          <div class="flex group">
            <span @touchstart="navigateTo('findHomePage', 0)" href="#" class="px-3 "
              :class="{ 'text-yellow-500': nav == 0, 'text-gray-400': nav != 0 }">
              <span class="flex flex-col items-center">
                ...
                <span class="h-2 w-2 rounded-full 
                  ...
                  :class="{ 'bg-yellow-500': nav == 0 }"></span>
              </span>
            </span>
          </div>
          ...
          <!-- Item #2 -->
          <div class="flex group">
            <span @touchstart="navigateTo('chat', 1)" href="#" class="px-3 "
              :class="{ 'text-yellow-500': nav == 1, 'text-gray-400': nav != 1 }">
              <span class="flex flex-col items-center">
                <!-- Icon -->
                <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 24 24">
                ...
                <span class="h-2 w-2 rounded-full 
                                            transition-all duration-150 delay-100"
                  :class="{ 'bg-yellow-500': nav == 1 }"></span>
              </span>
            </span>
          </div>
          ...
          <!-- Item #3 Active -->
          <div class="flex group">
            <span @touchstart="navigateTo('createPage', 2)" href="#" class="px-3 "
              :class="{ 'text-yellow-500': nav == 2, 'text-gray-400': nav != 2 }">
              <span class="flex flex-col items-center">
                <!-- Icon -->
                <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 32 32">
                  <g fill="none">
                    ...
                    <g fill="#fff">
                      ...
                      <path
                        d="M25.35 13.425a9.558 9.558 0 0 0-1.896-3.59l.9-.746a10.71 10.71 0 0 1 2.125 4.025zM6.86 21.976a10.742 10.742 0 0 1-1.793-5.956c0-2.962 1.18-5.728 3.323-7.789l.814.837a9.564 9.564 0 0 0-2.966 6.952c0 1.899.554 3.737 1.6 5.316z"
                        opacity="0.5" />
                    </g>
                  </g>
                </svg>
                ...
                <span class="h-2 w-2 rounded-full 
                                            transition-all duration-150 delay-100"
                  :class="{ 'bg-yellow-500': nav == 2 }"></span>
              </span>
            </span>
          </div>
          ...
          <!-- Item #4 -->
          <div class="flex group">
            <span @touchstart="navigateTo('messageIndex', 3)" href="#" class="px-3 "
              :class="{ 'text-yellow-500': nav == 3, 'text-gray-400': nav != 3 }">
              <span class="flex flex-col items-center">
                <!-- Icon -->
                ...
                <span class="h-2 w-2 rounded-full 
                                            transition-all duration-150 delay-100"
                  :class="{ 'bg-yellow-500': nav == 3 }"></span>
              </span>
            </span>
          </div>
          ...
          <!-- Item #5 -->
          <div class="flex group">
            <span @touchstart="navigateTo('profile', 4)" href="#" class="px-3 "
              :class="{ 'text-yellow-500': nav == 4, 'text-gray-400': nav != 4 }">
              <span class="flex flex-col items-center">
                <!-- Icon -->
                ...
                <span class="h-2 w-2 rounded-full 
                                            transition-all duration-150 delay-100"
                  :class="{ 'bg-yellow-500': nav == 4 }"></span>
              </span>
            </span>
          </div>
        </div>
